...
БЕСПЛАТНЫЙ ПРЕВЬЮ:
1. «КТО Я ✦»
2. «Как ты проявляешься» - сначала одним коротким предложением объясни, что показывает Асцендент, затем дай 2-3 содержательных предложения синтеза.
...
7. В конце блок «🔒 КАК РАСКРЫТЬ СЕБЯ СИЛЬНЕЕ» с четырьмя короткими пунктами: как проявлять себя через Солнце и что зажигает; что гасит; как использовать ресурс тени; как возвращаться к эмоциональному комфорту. Не раскрывай ответы бесплатно.
...
Кратко напомни индивидуальную основу карты, затем раскрой четыре темы: что реально зажигает и помогает проявляться; что гасит и тормозит; как использовать ресурс противоположного знака без крайностей; как восстанавливаться эмоционально. Давай конкретные наблюдения и действия. Не повторяй бесплатный текст дословно.
...
Главный герой блока - Венера. Обязательно синтезируй её знак, дом, достоинства/ослабления и значимые связи. Десцендент обязателен: объясни простыми словами, какой тип людей особенно часто притягивается в значимые отношения один на один. Внутренне учитывай Луну, Марс, Солнце, управителя VII дома, V и VIII дома, если они реально добавляют смысл.
...
5. «Что может мешать гармонии» - только 1-2 самые сильные темы, без нагнетания.
...
ПОЛНЫЙ ПЛАТНЫЙ РАЗБОР:
Раскрой именно практическую часть: подходящий тип партнёра и динамика долгих отношений; сохранение близости, доверия и интереса; уязвимые сценарии и способы не разрушать отношения; способы расслабляться, получать удовольствие и поддерживать самоценность. Дай конкретные действия и наблюдения. Не повторяй бесплатный текст дословно.
""",
    "career_money": """
...
4. «Как у тебя устроена тема денег» - отношение к ресурсам, способ зарабатывать, сильные и слабые привычки, но не раскрывай весь денежный алгоритм.
...
ПОЛНЫЙ ПЛАТНЫЙ РАЗБОР:
Дай практический финансово-профессиональный разбор: главный ресурс, каналы монетизации, подходящие модели работы, что масштабировать, что мешает доходу, где возможны утечки и какие конкретные шаги помогут. Не повторяй бесплатную часть дословно.
""",
    "nodes": """
ЗАГОЛОВОК: «КАРМИЧЕСКИЕ УЗЛЫ ☊».
Это символическая астрологическая интерпретация, а не доказанный факт о прошлых жизнях. Анализируй Северный и Южный узлы по знакам и точным домам, их ось, соединения и существенные аспекты, управителей знаков узлов, а также связи с Солнцем, Луной, Асцендентом, MC, стеллиумами и доминирующими темами. Южный узел описывай как знакомый, естественный паттерн и уже наработанную способность. Северный - как направление развития, которое осваивается постепенно. Не пугай и не используй фатализм.

БЕСПЛАТНЫЙ ПРЕВЬЮ:
1. «С чем ты пришла» - привычные способности и сценарии Южного узла.
2. «Куда тебя ведёт жизнь» - направление Северного узла.
3. «Что притягивается в твою жизнь» - повторяющиеся темы и ситуации, если карта это подтверждает.
4. «Твои кармические учителя» - какие типы людей или жизненные обстоятельства особенно двигают развитие, только если это следует из карты.
5. «Если коротко» - новый синтез.
6. В конце тизер «🔒 КАК ПРОЙТИ СВОИ КАРМИЧЕСКИЕ УРОКИ»: какие качества развивать; что из привычного помогает, а что удерживает; какие действия двигают к задаче; как не возвращаться в повторяющийся сценарий. Не раскрывай ответы полностью.

ПОЛНЫЙ ПЛАТНЫЙ РАЗБОР:
Практически раскрой переход от Южного к Северному узлу. Дай конкретные действия, выборы, навыки, способы использовать прошлый опыт без застревания и признаки того, что человек движется в нужную сторону. Не повторяй бесплатную часть дословно.
""",
    "growth": """
...
2. Покажи триггеры и реакцию под давлением.
...
ПОЛНЫЙ ПЛАТНЫЙ РАЗБОР:
Для каждой выбранной точки роста дай конкретные способы гармонизации, поведенческие действия, безопасные выходы напряжения, признаки перегруза и зрелую форму этой же энергии. Не повторяй бесплатную часть дословно.
""",
    "child": """
...
ПОЛНЫЙ ПЛАТНЫЙ РАЗБОР:
Дай подробный, но бережный разбор потенциала: таланты, стиль обучения, мотивация, эмоциональные потребности, коммуникация, инициативность, социализация, возможные направления интересов/профессий и практические рекомендации родителю. Отдельно полно раскрой кармические узлы. Не повторяй бесплатную часть дословно.
""",
}
...
БЕСПЛАТНЫЙ текст должен давать узнавание и несколько конкретных наблюдений, но оставлять практический алгоритм для платной части.
ПЛАТНЫЙ текст должен отвечать «что с этим делать» и давать конкретные действия.
Объём бесплатного текста ориентировочно 550-850 слов. Полного - 750-1100 слов. Не растягивай текст ради объёма.
