...
6. «Если коротко» - новый синтез без повторов.
7. В конце тизер «🔒 КАК ПРОЙТИ СВОИ КАРМИЧЕСКИЕ УРОКИ»: как двигаться к Северному узлу через конкретные действия; какие качества развивать; что из Южного узла использовать как ресурс, а что перестать делать автоматически; какие повторяющиеся сценарии важно менять. Не раскрывай весь алгоритм бесплатно.

ПОЛНЫЙ ПЛАТНЫЙ РАЗБОР:
Главный вопрос платной части: «Что конкретно мне делать, чтобы двигаться к своему Северному узлу и реализовывать направление развития?»
...
- для каждой болевой точки дай конкретный новый выбор или действие;
- дай 3-6 практических действий, которые можно реально внедрять в жизнь и которые соответствуют именно Северному узлу этого человека;
...
- не ограничивайся фразами вроде «развивай коммуникацию» или «будь самостоятельнее»: переводи это в конкретные действия, привычки, решения, обучение, тип взаимодействия с людьми или жизненные задачи;
- не повторяй бесплатную часть дословно.

Платная часть должна закрыть вопросы «ПОЧЕМУ я снова попадаю в этот сценарий?» и «КАК мне действовать иначе?».
""",
    "growth": """
